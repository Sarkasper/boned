...
The Bones starting CSS includes:

* [Normalize.css](https://github.com/necolas/normalize.css).
* Useful defaults.
* Common helpers.
* A responsive and mobile friendly skeleton.
...
* Basic styles for common used elements.
...
A base 960 Grid designed to scale down to Tablet (Portrait) and Mobile (Portrait+Landscape) viewports.
